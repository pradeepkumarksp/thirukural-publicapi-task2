...
// create input for input handling
var input=document.createElement('input');
input.setAttribute('type','text');
input.setAttribute('id','number');
input.setAttribute('placeholder','Enter the kural number here...')

// create button for kural search
...
// append all the element into div
